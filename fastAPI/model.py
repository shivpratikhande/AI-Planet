...
class PdfProcessor:
    ...
    def process_pdf(self, file_path):
        ...
        # Text Splitter for chunking the content
...
if __name__ == "__main__":
    ...
    google_api_key = "AIzaSyD_AM1vtBozbFogrkUUoviWmljs78KBLkI"  # Replace with your actual API key
    pdf_processor = PdfProcessor(google_api_key)

    # Test with a PDF file (ensure the file path is correct)
    file_path = "uploads/file.pdf"  # Replace with actual file path
