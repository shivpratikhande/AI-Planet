...
class PdfProcessor:
    ...
    def process_pdf(self, file_path):
        ...
        template = """Use the following pieces of context to answer the question at the end. If you don't know the answer. Keep the answer as concise as possible. Always say "thanks for asking!" or similar something greeting at the end of the answer.
        {context}
        Question: {question}
        Helpful Answer:"""
